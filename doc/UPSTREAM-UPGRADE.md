...
|---|---|---|---|---|
| Announcement feed | `PAPERCLIP_ANNOUNCEMENTS_ENABLED=false` (opt-out) | päällä, hakee `pages.paperclip.ing` | v2026.916.1 | env, `export` tiedostossa `paperclip-start.sh` |
